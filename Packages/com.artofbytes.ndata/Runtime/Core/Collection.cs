...
namespace NData
{
    ...
    public class Collection<T> : Collection, IEnumerable<T> where T : Context
    {
		...
		#region SelectedItem
		public readonly VariableContext<T> SelectedItemEzVariableContext =
			new VariableContext<T>(null);
